...
// {
	...
	// {
		...
		// {
			...
			// {
				// if( level1.layers[layersIdx[.data[idx] != 0)
				// {
...
function run()
{
	...
	context.drawImage(scoreImage, SCREEN_WIDTH - 1250, 700);
	var scoreText = "Score: " + score;
	context.fillText(scoreText, SCREEN_WIDTH - 1200, 750);
	
	for(var i=0; i<lives; i++)
	{
		context.drawImage(heartImage, 500 + ((heartImage.width+2)*i), 750);
	}
